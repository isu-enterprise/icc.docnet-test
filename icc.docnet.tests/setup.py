...
ext_modules=[
#    Extension("icc.docnet.tests.cython_module",
#              sources=["src/./icc.docnet.tests/cython_module.pyx"],
#              libraries=["gdal"],
#    )
]

setup(
    name='icc.docnet.tests',
    version=version,
    description="Test package abd data for icc.docnet/icc.cellula",
    ...
    #     """.split('\n') if c.strip()],
    # ],
    keywords='icc.docnet tests',
    author='Evgeny Cherkashin',
    author_email='eugeneai@irnok.net',
    url='https://github.com/isu-enterprise/icc.docnet-test',
    license='GPLv3.0',
    packages=find_packages("src"),
    package_dir = {'': "src"},
    namespace_packages = ['icc', 'icc.docnet'],
    ...
    entry_points={
        'console_scripts':
            ['icc.docnet.tests=icc.docnet.tests:main']
    },
